...
@Entity
@Table(name="BIPS_BUSINESS_CENTRAL_ACCOUNT_MONITORING_MOD_TABLE")
public class CreditBankAgentTmpTable {
	...
	public CreditBankAgentTmpTable() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CreditBankAgentTmpTable(String acct_number, String acct_name, String acct_crncy_code, String bank_code,
			String bank_name, String bc_gl_id, String bc_acct_type, String bc_dimension_id, String tran_type,
			String remarks, BigDecimal debit_cap, String entry_user, Date entry_time, String modify_user,
			Date modify_time, String verify_user, Date verify_time, String user_field_1, String user_field_2,
			Date user_field_3, Date user_field_4, String entry_flag, String modify_flag, String verify_flag,
			String del_flg, String bank_agent, String disable_flg, String del_user, String disable_user, Date del_time,
			Date disable_time,String new_bank_flg) {
		super();
		this.acct_number = acct_number;
		this.acct_name = acct_name;
		this.acct_crncy_code = acct_crncy_code;
	...
	public CreditBankAgentTmpTable(Business_central_bank_detail_entity bc_bank_detail_entity) {
		// TODO Auto-generated constructor stub
	...
	public String toString() {
		return "CreditBankAgentTmpTable [acct_number=" + acct_number + ", acct_name=" + acct_name + ", acct_crncy_code="
				+ acct_crncy_code + ", bank_code=" + bank_code + ", bank_name=" + bank_name + ", bc_gl_id=" + bc_gl_id
				+ ", bc_acct_type=" + bc_acct_type + ", bc_dimension_id=" + bc_dimension_id + ", tran_type=" + tran_type
				+ ", remarks=" + remarks + ", debit_cap=" + debit_cap + ", entry_user=" + entry_user + ", entry_time="
				+ entry_time + ", modify_user=" + modify_user + ", modify_time=" + modify_time + ", verify_user="
				+ verify_user + ", verify_time=" + verify_time + ", user_field_1=" + user_field_1 + ", user_field_2="
				+ user_field_2 + ", user_field_3=" + user_field_3 + ", user_field_4=" + user_field_4 + ", entry_flag="
				+ entry_flag + ", modify_flag=" + modify_flag + ", verify_flag=" + verify_flag + ", del_flg=" + del_flg
				+ ", bank_agent=" + bank_agent + ", disable_flg=" + disable_flg + ", del_user=" + del_user
				+ ", disable_user=" + disable_user + ", del_time=" + del_time + ", disable_time=" + disable_time
				+ ", new_bank_flg=" + new_bank_flg + "]";
	}
