...
@Entity
@Table(name="BIPS_TRAN_QR_NOTIFICATION_TABLE")
public class TranQRNotificationTable implements Serializable{
	/**
	 * 
	 */
	...
	public TranQRNotificationTable() {
		super();
	...
	public TranQRNotificationTable(String sequence_unique_id, String request_uuid, String channel_id,
			...
			String beneficiaryswiftcode, String tran_status, String pid, String device_id) {
		super();
		this.sequence_unique_id = sequence_unique_id;
		this.request_uuid = request_uuid;
		this.channel_id = channel_id;
