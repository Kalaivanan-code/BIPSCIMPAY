...
@Override
	public String toString() {
		return "Feestranparition [merchant_id=" + merchant_id + ", merchant_acct_no=" + merchant_acct_no
				+ ", merchant_trading_name=" + merchant_trading_name + ", tran_type=" + tran_type + ", tran_date="
				+ tran_date + ", value_date=" + value_date + ", tran_id=" + tran_id + ", part_tran_id=" + part_tran_id
				+ ", part_tran_type=" + part_tran_type + ", tran_ref_cur=" + tran_ref_cur + ", tran_ref_cur_amt="
				+ tran_ref_cur_amt + ", tran_rate=" + tran_rate + ", tran_amt_loc=" + tran_amt_loc
				+ ", tran_particular=" + tran_particular + ", tran_remarks=" + tran_remarks + ", partition_type="
				+ partition_type + ", partition_detail=" + partition_detail + ", cust_ref=" + cust_ref + ", loan_ref="
				+ loan_ref + ", participant_bank=" + participant_bank + ", ipsx_account_number=" + ipsx_account_number
				+ ", ipsx_acct_name=" + ipsx_acct_name + ", tran_type_code=" + tran_type_code + ", dbtr_agt=" + dbtr_agt
				+ ", cdtr_agt=" + cdtr_agt + ", tran_rmks=" + tran_rmks + ", srl_num=" + srl_num + ", business_date="
				+ business_date + ", posting=" + posting + "]";
	}
public Feestranparition() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Feestranparition(String merchant_id, String merchant_acct_no, String merchant_trading_name, String tran_type,
			Date tran_date, Date value_date, String tran_id, BigDecimal part_tran_id, String part_tran_type,
			String tran_ref_cur, BigDecimal tran_ref_cur_amt, BigDecimal tran_rate, BigDecimal tran_amt_loc,
			String tran_particular, String tran_remarks, String partition_type, String partition_detail,
			String cust_ref, String loan_ref, String participant_bank, String ipsx_account_number,
			String ipsx_acct_name, String tran_type_code, String dbtr_agt, String cdtr_agt, String tran_rmks,String srl_num,Date business_date, Date posting) {
		super();
		this.merchant_id = merchant_id;
		this.merchant_acct_no = merchant_acct_no;
		this.merchant_trading_name = merchant_trading_name;
