...
public class CimCBSrequestDatanew {
	...
	public String getIpsxTranStatus() {
		return ipsxTranStatus;
	}

	public void setIpsxTranStatus(String ipsxTranStatus) {
	...
	public String toString() {
		return "CimCBSrequestDatanew [branchId=" + branchId + ", transactionNo=" + transactionNo
				+ ", initiatingChannel=" + initiatingChannel + ", initatorTransactionNo=" + initatorTransactionNo
				+ ", initatorSubTransactionNo=" + initatorSubTransactionNo + ", PostToCBS=" + PostToCBS
				+ ", transactionType=" + transactionType + ", isReversal=" + isReversal + ", transactionNoFromCBS="
				+ transactionNoFromCBS + ", customerName=" + customerName + ", fromAccountNo=" + fromAccountNo
				+ ", toAccountNo=" + toAccountNo + ", transactionAmount=" + transactionAmount + ", transactionDate="
				+ transactionDate + ", transactionCurrency=" + transactionCurrency + ", transactionParticularCode="
				...
				+ ipsxTranStatus + ", pId=" + pId + ", psuDeviceId=" + psuDeviceId + ", notificationChannel="
				+ notificationChannel + "]";
	}
