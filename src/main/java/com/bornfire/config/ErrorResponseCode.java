...
public class ErrorResponseCode {
	public String ErrorCode(String code) {
		...
		/*
		 * if (code.equals("BOB0")) { responseDesc = "BOB0:Success"; } else if
		 * (code.equals("BOB114")) { responseDesc = "AC01:Incorrect Account Number"; }
		 * else if (code.equals("BOB116")) { responseDesc = "AM04:Insufficient Funds"; }
		 * else if (code.equals("BOB119")) { responseDesc =
	...
	public String ErrorCodeRegistration(String code) {
		...
		} else if (code.equals("CIM02")) {
			responseDesc = "CIM02:Failure";
		}
